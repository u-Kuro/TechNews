        ...
        <div class="row">
            <div class="col-md-8">
                <div class="post-container">
                    ...
                    ($posts_result = mysqli_query($conn, $posts_sql)) or die("Query failed: fetch posts");
                    ...
                    <?php
                    // Pagination
                    $all_posts_count_sql = "SELECT COUNT(*) as total FROM post";
                    ($all_posts_count_result = mysqli_query($conn, $all_posts_count_sql)) or die("Query Failed");

                    $all_posts_count_row = mysqli_fetch_assoc($all_posts_count_result);
                    if ((int)$all_posts_count_row["total"] > 0) {
                        $total_records = (int)$all_posts_count_row["total"];
